...
### Interview Notes
The NYPL's [Library Simplified](http://www.librarysimplified.org/) Android client. Prior to your interview, please build the `simplified-app-vanilla` module of this project.
