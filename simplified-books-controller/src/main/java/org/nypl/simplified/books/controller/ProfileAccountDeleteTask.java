...
import static org.nypl.simplified.accounts.api.AccountEventDeletion.AccountDeletionFailed.ErrorCode.ERROR_ACCOUNT_ONLY_ONE_REMAINING;
import static org.nypl.simplified.accounts.api.AccountEventDeletion.AccountDeletionFailed.ErrorCode.ERROR_GENERAL;
import static org.nypl.simplified.profiles.api.ProfileAccountSelectEvent.ProfileAccountSelectSucceeded;
  ...
  protected AccountEventDeletion execute() {
    ...
    try {
      ...
      if (provider != null) {
        ...
        return AccountEventDeletion.AccountDeletionSucceeded.of(account_now.id(), provider);
      }
