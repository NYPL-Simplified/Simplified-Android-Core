...
public class DeviceManagerPostTask
  implements Runnable
{
  private static final Logger LOG = LoggerFactory.getLogger(DeviceManagerPostTask.class);

  private final AccountCredentials creds;

  DeviceManagerPostTask(
      ...
      try {
        ...
        if (licensor.getDeviceManager().isSome()) {
          ...
          if (this.creds.getAdobeDeviceID().isSome()) {
            ...
            final OptionType<HTTPAuthType> http_auth = Option.some((HTTPAuthType)
