...
public class BugsnagDummy implements BugsnagType {
   ...
   */
  @Override
  public void notify(final Throwable exception) {
   ...
   */
  @Override
  public void notify(final Throwable exception, final Severity severity) {
   ...
   */
  @Override
  public void addToTab(final String tab, final String key, final Object value) {
   ...
   */
  @Override
  public void leaveBreadcrumb(final String message) {
