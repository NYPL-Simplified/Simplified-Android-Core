...
public class HomeAddressConfirmFragment extends Fragment {
    ...
    public  HomeAddressConfirmFragment newInstance(AddressResponse response) {
        HomeAddressConfirmFragment fragment = new HomeAddressConfirmFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_home_address_confirm, container, false);
        ((TextView) rootView.findViewById(android.R.id.title)).setText("Confirm Home Address");
...

        {
            ...
            if (mResponse.type.equals("valid-address"))
            {
                ...
                final Address alternate_address = mResponse.address;
                    ...
                    if (mPrefs.getInt(Constants.SELECTED_ADDRESS) == finalIndex) {
                        rb[finalIndex].setChecked(true);
                        mPrefs.putString(Constants.STREET1_H_DATA_KEY, alternate_address.line_1);
                        mPrefs.putString(Constants.STREET2_H_DATA_KEY, alternate_address.line_2);
                        mPrefs.putString(Constants.CITY_H_DATA_KEY, alternate_address.city);
                        mPrefs.putString(Constants.STATE_H_DATA_KEY, alternate_address.state);
                        mPrefs.putString(Constants.ZIP_H_DATA_KEY, alternate_address.zip);
                    ...
                    rb[finalIndex].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            mPrefs.putInt(Constants.SELECTED_ADDRESS, finalIndex);
                            mPrefs.putString(Constants.STREET1_H_DATA_KEY, alternate_address.line_1);
                            mPrefs.putString(Constants.STREET2_H_DATA_KEY, alternate_address.line_2);
                            mPrefs.putString(Constants.CITY_H_DATA_KEY, alternate_address.city);
                            mPrefs.putString(Constants.STATE_H_DATA_KEY, alternate_address.state);
