...
data class BodyNode(
  @field:JsonProperty("http://librarysimplified.org/terms/time")
  val timestamp: String,
  @field:JsonProperty("http://librarysimplified.org/terms/device")
  val device: String,
  @field:JsonProperty("http://librarysimplified.org/terms/chapter")
  val chapterTitle: String?,
  @field:JsonProperty("http://librarysimplified.org/terms/progressWithinChapter")
  val chapterProgress: Float?,
  @field:JsonProperty("http://librarysimplified.org/terms/progressWithinBook")
