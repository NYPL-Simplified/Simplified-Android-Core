...
import static org.nypl.simplified.profiles.api.ProfilesDatabaseType.AnonymousProfileEnabled.ANONYMOUS_PROFILE_DISABLED;
...
public final class ProfilesDatabase implements ProfilesDatabaseType {
  ...
  private final AccountAuthenticationCredentialsStoreType account_credentials_store;
  ...
  private ProfilesDatabase(
    ...
    this.account_credentials_store =
      Objects.requireNonNull(account_credentials_store, "Account credentials store");
  ...
  private static final class Profile implements ProfileType {
    ...
    public AccountType account(final AccountID account_id)
      ...
      if (account == null) {
        throw new AccountsDatabaseNonexistentException("Nonexistent account: " + account_id);
      }
    ...
    void setAccountCurrent(final AccountID id)
      ...
      synchronized (this.account_current_lock) {
        ...
        if (account != null) {
          ...
          throw new AccountsDatabaseNonexistentException("No such account: " + id);
        }
      }
    }
  }
