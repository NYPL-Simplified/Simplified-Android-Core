...
class SettingsMainFragment : PreferenceFragmentCompat() {
  ...
  private fun configureAcknowledgements(preference: Preference) {
    ...
    preference.onPreferenceClickListener =
      Preference.OnPreferenceClickListener {
        this.listener.post(SettingsMainEvent.OpenAcknowledgments)
        true
      }
  }
  ...
  private fun configureLicense(preference: Preference) {
    ...
    preference.onPreferenceClickListener =
      Preference.OnPreferenceClickListener {
        this.listener.post(SettingsMainEvent.OpenLicense)
        true
      }
  }
  ...
  private fun configureFaq(preference: Preference) {
    ...
    preference.onPreferenceClickListener =
      Preference.OnPreferenceClickListener {
        this.listener.post(SettingsMainEvent.OpenFAQ)
        true
      }
  }
  ...
  private fun configureEULA(preference: Preference) {
    ...
    preference.onPreferenceClickListener =
      Preference.OnPreferenceClickListener {
        this.listener.post(SettingsMainEvent.OpenEULA)
        true
      }
  }
  ...
  private fun configureAbout(preference: Preference) {
    ...
    preference.onPreferenceClickListener =
      Preference.OnPreferenceClickListener {
        this.listener.post(SettingsMainEvent.OpenAbout)
        true
      }
  }
