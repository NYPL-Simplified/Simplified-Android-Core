...
public final class SplashColorMatrix extends ColorMatrix
{
  private SplashColorMatrix(
    final float[] actual)
  {
    super(actual);
  }
  ...
  public static SplashColorMatrix fromRows(
    final float[] row_0,
    final float[] row_1,
    final float[] row_2,
    final float[] row_3)
  {
    ...
    Preconditions.checkArgument(
      ...
      Integer.valueOf(4 * 5));
    return new SplashColorMatrix(actual);
  }
  ...
  public static ColorMatrixColorFilter getImageFilterMatrix(
    final int c)
  {
    final SplashColorMatrix inversion;
    final SplashColorMatrix tint;

    {
      ...
      // CHECKSTYLE_SPACE:ON
      inversion = SplashColorMatrix.fromRows(row_0, row_1, row_2, row_3);
    }

    {
      ...
      final float[] row_3 = { 0.0F, 0.0F, 0.0F, 1.0F, 0.0F };
      // CHECKSTYLE_SPACE:ON
      tint = SplashColorMatrix.fromRows(row_0, row_1, row_2, row_3);
    }
